                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text("Ynotes",
                              style: TextStyle(color: theme.colors.foregroundColor, fontSize: YFontSize.base)),
                          Text("Ynotes", style: TextStyle(color: theme.colors.foregroundColor, fontSize: YFontSize.lg)),
                          Text("Ynotes",
                              style: TextStyle(color: theme.colors.foregroundColor, fontSize: YFontSize.xl2)),
                          Text("Ynotes",
                              style: TextStyle(color: theme.colors.foregroundColor, fontSize: YFontSize.xl3)),
                          Text("Ynotes",
                              style: TextStyle(color: theme.colors.foregroundColor, fontSize: YFontSize.xl4)),
                          Text("Ynotes",
                              style: TextStyle(color: theme.colors.foregroundColor, fontSize: YFontSize.xl5)),
                          Text("Ynotes",
                              style: TextStyle(color: theme.colors.foregroundColor, fontSize: YFontSize.xl6)),
                          Text("Ynotes",
                              style: TextStyle(color: theme.colors.foregroundColor, fontSize: YFontSize.xl7)),
                        ],
                      ),
                    ),
                    Wrap(
