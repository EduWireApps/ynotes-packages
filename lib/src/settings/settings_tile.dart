...
class YSettingsTile extends StatelessWidget {
  ...
  /// The condition that determines if the tile is enabled.
  final bool enabled;

  /// The action to perform when the tile is tapped and [enabled] set to false.
    ...
    return Opacity(
      ...
      child: ListTile(
        ...
        trailing: trailing != null
            ...
            : null,
        onTap: enabled ? onTap : disabledOnTap,
  ...
  Widget switchTile(BuildContext context) {
    return Opacity(
      ...
      child: ListTile(
        ...
        trailing: Padding(
          padding: YPadding.pl(YScale.s3),
          child: YSwitch(value: switchValue!, onChanged: enabled ? onSwitchValueChanged! : (b) {}),
        ),
        onTap: enabled ? () => onSwitchValueChanged!(!switchValue!) : disabledOnTap,
        horizontalTitleGap: YScale.s3,
        contentPadding: YPadding.px(YScale.s6),
        minVerticalPadding: YScale.s3,
      ),
